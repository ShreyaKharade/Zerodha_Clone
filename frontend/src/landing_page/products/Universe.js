    ...
    <div className="container mt-5">
      <div className="row text-center">
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/smallcaseLogo.png" style={{width:"160px"}}/>
        ...
        <div className="col-4 p-3 mt-5">
          <img src="media/images/zerodhaFundhouse.png"style={{width:"160px"}} />
          <p className="text-small text-muted">Asset management platform</p>
        </div>
        <div className="col-4 p-3 mt-5">
          <img src="media/images/goldenpiLogo.png" style={{width:"160px"}}/>
