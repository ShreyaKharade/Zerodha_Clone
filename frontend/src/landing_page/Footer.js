    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5 text-muted" style={{ fontSize: "14px" }}>
          ...
          <div className="col-md-3">
            <p className=" text-dark fs-5">Company</p>
            <p className="mb-1">About</p>
            <p className="mb-1">Products</p>
            <p className="mb-1">Pricing</p>
            <p className="mb-1">Referral programme</p>
          ...
          <div className="col-md-3">
            <p className="text-dark fs-5">Support</p>
            <p className="mb-1">Contact</p>
            <p className="mb-1">Support portal</p>
            <p className="mb-1">Z-Connect blog</p>
            <p className="mb-1">List of charges</p>
            <p className="mb-1">Downloads & resources</p>
          </div>

          <div className="col-md-3">
            <p className="text-dark fs-5">Account</p>
            <p className="mb-1">Open an account</p>
            <p className="mb-1">Fund transfer</p>
            <p className="mb-1">60 day challenge</p>
          </div>
        </div>
